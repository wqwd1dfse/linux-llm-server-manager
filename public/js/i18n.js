...
const translations = {
  'zh-CN': {
    ...
    'settings.perf_title': '⏱️ 功能数据自动刷新周期',
    'settings.perf_label': '客户端轮询频率',
    'settings.perf_note': '控制风扇曲线、LLM 状态与下载任务轮询；硬件遥测由服务端 METRICS_INTERVAL 控制。',
    ...
    'settings.hf_token_clear': '清除 Token',
  ...
  'en-US': {
    ...
    'settings.perf_title': '⏱️ Feature Refresh Interval',
    'settings.perf_label': 'Client Polling Frequency',
    'settings.perf_note': 'Controls fan charts, LLM status, and download tasks. Server telemetry uses METRICS_INTERVAL.',
    ...
    'settings.hf_token_clear': 'Clear token',
